...
CREATE TABLE `emprestimos` (
  ...
  `identificador_livro` int(11) DEFAULT NULL,
...
INSERT INTO `emprestimos` VALUES (1,2,1,3,'2017-06-20 17:44:00','2017-06-27 06:06:00');
...
CREATE TABLE `livro_fisico` (
  ...
  `codigo_livro` varchar(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo_livro` (`codigo_livro`),
...
INSERT INTO `livro_fisico` VALUES (1,2,1,'474744'),(2,2,1,'58556'),(3,2,0,'5856');
...
-- Dump completed on 2017-06-27 13:31:21
