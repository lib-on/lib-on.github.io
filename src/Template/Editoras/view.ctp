    ...
    <div class="row content">
        <div class="col-sm-3 sidenav">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><?= $this->Html->link(__(' Editar Editora'), ['action' => 'edit', $editora->id], ['class' => 'fa fa-pencil-square']) ?> </li>
                <li><?= $this->Form->postLink(__(' Deletar Editora'), ['action' => 'delete', $editora->id], ['class' => 'fa fa-trash'], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', $editora->id)]) ?> </li>
