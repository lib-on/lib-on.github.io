    ...
    <div class="row content">
        <div class="col-sm-3 sidenav">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><?= $this->Html->link(__(' Editar Categoria'), ['action' => 'edit', $categoria->id], ['class' => 'fa fa-pencil-square']) ?> </li>
                <li><?= $this->Form->postLink(__(' Deletar Categoria'), ['action' => 'delete', $categoria->id], ['class' => 'fa fa-trash'], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', $categoria->id)]) ?> </li>
