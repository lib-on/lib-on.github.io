            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__(' Visualizar'), ['action' => 'view', $emprestimo->id], ['class' => 'fa fa-eye btn btn-info']) ?>
                            <?= $this->Html->link(__(' Editar'), ['action' => 'edit', $emprestimo->id], ['class' => 'fa fa-pencil-square btn btn-default']) ?>
                            <?= $this->Form->postLink(__(' Deletar'), ['action' => 'delete', $emprestimo->id], ['class' => 'fa fa-trash btn btn-danger'], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', $emprestimo->id)]) ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
